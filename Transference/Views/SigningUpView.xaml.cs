...
{
    public partial class SigningUpView : ContentPage
    {
        private Timer _timer; // Utiliza el tipo completo para evitar ambigüedades

        public SigningUpView(SigningUpViewModel viewModel)
        {
            InitializeComponent();
        ...
        {
            // Puedes intentar eliminar el Task.Delay si no es necesario
